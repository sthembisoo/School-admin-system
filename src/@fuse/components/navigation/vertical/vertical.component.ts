...
import { BehaviorSubject, merge, ReplaySubject, Subject, Subscription } from 'rxjs';
...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    {
        // this.userRoles = this.navigationservice.userdata;
        // if(this.userRoles.length !== 0)
        // {
        //     this.navigation = [...this.navigationservice.userdata[0]]
        // }
    ...
    async ngOnInit(): Promise<void>
    {
       ...
       let  Resolvedroles= this.route.snapshot.data.initialData[1];
       console.log(Resolvedroles.value)
        await (
            await Resolvedroles
        ).subscribe(
