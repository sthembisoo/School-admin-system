...
import { StaffEventsService } from '@services/staff-events.service';
...
export class CalendarService
{
     ...
     * Constructor
     */
    constructor(private _httpClient: HttpClient, private staffEvents: StaffEventsService)
    {
    }
    ...
    addEvent(event): Observable<CalendarEvent>
    {
        return this.events$.pipe(
            take(1),
            switchMap(events => this.staffEvents.addStaffEvent(event).pipe(
                map((addedEvent) => {
